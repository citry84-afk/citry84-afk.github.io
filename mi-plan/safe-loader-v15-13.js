(async()=>{
  ...
  const loadOptions=async()=>{
    const response=await fetch('./options-intuitive-v12.js?v=15.13',{cache:'no-store'});
    if(!response.ok)throw new Error('No se pudo cargar el módulo de opciones');
    let source=await response.text();
    source=source.replace('function render(){','function render(){globalThis.FFOptionsRender1513=render;');
    (0,eval)(source);
  };
  ...
  try{
    const parts=Array.from({length:9},(_,i)=>`./portrait-v4-${String(i+1).padStart(2,'0')}.part?v=15.13`);
    ...
    if(!document.querySelector('link[data-map-v5]')){const link=document.createElement('link');link.rel='stylesheet';link.href='./map-v5.css?v=15.13';link.dataset.mapV5='1';document.head.appendChild(link)}
    await loadScript('./map-v5.js?v=15.13');
    await loadScript('./visual-v10.js?v=15.13');
    await loadOptions();
    try{
      await loadScript('./options-v14-4-core.js?v=15.13');
      await loadScript('./options-v14-2-core.js?v=15.13');
      await loadScript('./options-v14-3-core.js?v=15.13');
      window.FFv143?.migrate?.();window.FFv144?.migrate?.();
      await loadScript('./options-v14.js?v=15.13');
      await loadScript('./options-v14-3-ui.js?v=15.13');
      await loadScript('./options-v14-4-ui.js?v=15.13');
    }catch(error){console.warn('[v15.13] La capa avanzada de opciones no se cargó.',error)}
    await loadScript('./v15-core.js?v=15.13');
    await loadScript('./v15-ui.js?v=15.13');
    await loadScript('./onboarding-banks-v15-1.js?v=15.13');
    await loadScript('./screenshot-reader-v15-3.js?v=15.13');
    await loadScript('./bank-finalizer-v15-3.js?v=15.13');
    await loadScript('./ownership-totals-v15-5.js?v=15.13');
    await loadScript('./broker-import-v15-5-core.js?v=15.13');
    await loadScript('./onboarding-brokers-v15-5.js?v=15.13');
    await loadScript('./ibkr-shared-v15-6.js?v=15.13');
    await loadScript('./investment-onboarding-v15-6.js?v=15.13');
    await loadScript('./investment-consolidation-v15-9.js?v=15.13');
    await loadScript('./pension-income-import-v15-10.js?v=15.13');
    await loadScript('./property-onboarding-v15-12.js?v=15.13');
    await loadScript('./clean-dashboard-nav-v15-13.js?v=15.13');
