(async()=>{
  ...
  try{
    const parts=Array.from({length:9},(_,i)=>`./portrait-v4-${String(i+1).padStart(2,'0')}.part?v=15.5`);
    ...
    (0,eval)(text.join(''));
    if(!document.querySelector('link[data-map-v5]')){const link=document.createElement('link');link.rel='stylesheet';link.href='./map-v5.css?v=15.5';link.dataset.mapV5='1';document.head.appendChild(link)}
    await loadScript('./map-v5.js?v=15.5');
    await loadScript('./visual-v10.js?v=15.5');
    await loadScript('./options-intuitive-v12.js?v=15.5');
    await loadScript('./mobile-nav-v14.js?v=15.5');
    try{
      await loadScript('./options-v14-4-core.js?v=15.5');
      await loadScript('./options-v14-2-core.js?v=15.5');
      await loadScript('./options-v14-3-core.js?v=15.5');
      window.FFv143?.migrate?.();window.FFv144?.migrate?.();
      await loadScript('./options-v14.js?v=15.5');
      await loadScript('./options-v14-3-ui.js?v=15.5');
      await loadScript('./options-v14-4-ui.js?v=15.5');
    }catch(error){console.warn('[v15.5] La capa avanzada de opciones no se cargó.',error)}
    await loadScript('./v15-core.js?v=15.5');
    await loadScript('./v15-ui.js?v=15.5');
    await loadScript('./onboarding-banks-v15-1.js?v=15.5');
    await loadScript('./screenshot-reader-v15-3.js?v=15.5');
    await loadScript('./bank-finalizer-v15-3.js?v=15.5');
    await loadScript('./ownership-totals-v15-5.js?v=15.5');
    await loadScript('./broker-import-v15-5-core.js?v=15.5');
    await loadScript('./onboarding-brokers-v15-5.js?v=15.5');
